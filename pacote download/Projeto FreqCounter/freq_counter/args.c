...
const char *gengetopt_args_info_purpose = "Contar numero de bytes";

const char *gengetopt_args_info_usage = "Usage: freq_counter [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --compact        Produces the result of processing files in compact mode",
  "  -d, --dir=dirname    Processes regular files within the directory",
  "      --discrete=INT   Shows only the count of the values present in the list\n                         of values",
  "  -f, --file=STRING    Processes files in the list",
  "  -m, --mode=INT       Choose between octet (-m 1), bi-octet (-m 2) or\n                         quad-octet (-m 4). If the option is not specified, it\n                         is assumed to be -m 1  (possible values=\"1\", \"2\",\n                         \"4\" default=`1')",
  "  -o, --output=STRING  The results acquired by processing the files will be\n                         written to a file",
  "  -s, --search=STRING  Indicates all occurrences of the specified octet pattern",
  "      --time           Indicates execution time in seconds, accurately up to\n                         milliseconds",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->discrete_min = 0;
  args_info->discrete_max = 0;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_field (args_info->discrete_given, (void *)(args_info->discrete_arg), &(args_info->discrete_orig));
  args_info->discrete_arg = 0;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->discrete_given, "discrete", args_info->discrete_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->discrete_given, args_info->discrete_min, args_info->discrete_max, "'--discrete'"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * discrete_list = NULL;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* Produces the result of processing files in compact mode.  */
          ...
          break;
        case 'd':	/* Processes regular files within the directory.  */
          ...
          break;
        case 'f':	/* Processes files in the list.  */
          ...
          break;
        case 'm':	/* Choose between octet (-m 1), bi-octet (-m 2) or quad-octet (-m 4). If the option is not specified, it is assumed to be -m 1.  */
          ...
          break;
        case 'o':	/* The results acquired by processing the files will be written to a file.  */
          ...
          break;
        case 's':	/* Indicates all occurrences of the specified octet pattern.  */
        ...
        case 0:	/* Long option with no short option */
          /* Shows only the count of the values present in the list of values.  */
          if (strcmp (long_options[option_index].name, "discrete") == 0)
          {
          
            if (update_multiple_arg_temp(&discrete_list, 
          ...
          /* Indicates execution time in seconds, accurately up to milliseconds.  */
  ...
  update_multiple_arg((void *)&(args_info->discrete_arg),
    &(args_info->discrete_orig), args_info->discrete_given,
    local_args_info.discrete_given, 0,
    ARG_INT, discrete_list);
  ...
  args_info->discrete_given += local_args_info.discrete_given;
  local_args_info.discrete_given = 0;
